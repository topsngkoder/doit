-- Hotfix: гарантировать вставку новой колонки строго после source-колонки.
-- Причина: более ранняя версия RPC в уже применённой миграции могла оставлять поведение "в конец".
