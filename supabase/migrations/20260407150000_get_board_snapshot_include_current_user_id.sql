-- P3: Reduce SSR Auth queries by including current_user_id in snapshot.
...
COMMENT ON FUNCTION public.get_board_snapshot(uuid) IS
  'Aggregated board snapshot (P2) to reduce SSR/refresh query count for /boards/[boardId]. Includes current_user_id (P3).';
