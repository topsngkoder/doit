-- Repair: `get_board_snapshot.card_ready_attachments` must include `field_definition_id`.
-- Without it, UI grouping by Yandex Disk field drops all ready attachments.
