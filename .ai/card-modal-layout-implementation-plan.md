...
- Уточнение по фидбеку: удалено поле поиска меток. Добавлено меню выбора метки по клику на `Меток нет`, а также меню замены по клику на существующую метку.
- Уточнение по фидбеку: аватары `Участники карточки` перенесены в строку с переключателем `Детали/История`; отдельный заголовок секции участников убран.
- Уточнение по фидбеку: у ответственного участника (владельца карточки) добавлена тонкая золотистая обводка аватара для быстрого визуального акцента.
- Уточнение по фидбеку: под аватаром ответственного участника в строке вкладок добавлена компактная пометка `Отв.`.
- Уточнение по фидбеку: золотая обводка в строке участников перенесена с ответственного на автора карточки (`createdByUserId`).
- Уточнение по фидбеку: подпись `Отв.` у ответственного сделана синей (`text-sky-300`) и вынесена над аватаром (вне кружка).
- Уточнение по фидбеку: подпись `Отв.` у ответственного перемещена под аватар (снаружи кружка).
- Уточнение по фидбеку: текстовая подпись `Отв.` заменена на синий значок чемодана под аватаром ответственного.
