...
- [ ] **PC6.1 (todo)** Добавить пункт меню “Личный кабинет”
...
- [ ] **PC6.2 (todo)** Расширить protected‑маршруты в `web/src/middleware.ts`
